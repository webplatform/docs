...
* '''[[HTML/Elements/ul unordered list]]''' — used to group a set of related items, in no particular order.
* '''[[HTML/Elements/ol ordered list]]''' — used to group a set of related items, in a specific order.
* '''[[HTML/Elements/dl description list]]''' — used to display name/value pairs such as terms and their definitions, or times and events.
