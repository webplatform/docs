...
=== <code>longdesc</code> を使って、複雑な画像の代わりを用意する  <ref> 訳注： <code>longdesc</code> 属性は、ブラウザやスクリーンリーダーで実装があまり進んでいないようです。詳しくは [[http://waic.jp/docs/jis2010-as-understanding/201406/H45.html アクセシビリティ・サポーテッド（AS）情報：H45 ]] を参照してください。 </ref> ===
