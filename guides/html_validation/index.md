...
With most programming languages, the first error is impossible to overlook.  The program will refuse to compile until the error is fixed, and the compiler will usually alert the programmer of the error and the line number on which it can be found. This makes finding and fixing these types of errors much easier in those general head-scratching moments of “So why isn’t it doing what I want?”
