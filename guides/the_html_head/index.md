...
One feature HTML includes is a special element for identifying the character encoding of your documents: the range of different characters you want to use. In HTML5 t looks like so: 
