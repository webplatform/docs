...
|Overview=The LocalMediaStream object is the MediaStream object returned from the call to [[dom/methods/getUserMedia|getUserMedia()]]. It has all the properties and events of the MediaStream object and the stop method.
}}
{{Examples_Section
|Not_required=No
|Examples=
