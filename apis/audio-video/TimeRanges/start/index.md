...
{{API_Name}}
{{Summary_Section|Returns the time for the start of the range with the given index. Throws an IndexSizeError if the index is out of range.}}
{{API_Object_Method
...
|Is_CC-BY-SA=No
|Sources=MDN, MSDN
|MDN_link=https://developer.mozilla.org/en-US/docs/Web/API/TimeRanges.start
