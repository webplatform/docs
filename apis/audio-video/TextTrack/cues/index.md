...
|Notes=
===Remarks===
The following example gets the [[apis/audio-video/TextTrackCueList|'''TextTrackCueList''']] from a video element and displays all the text cues using the cues property.
