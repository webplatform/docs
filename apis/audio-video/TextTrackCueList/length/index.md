...
{{API_Name}}
{{Summary_Section|The length attribute returns the number of cues in the list represented by the TextTrackCueList.}}
{{API_Object_Property
|Property_applies_to=apis/audio-video/TextTrackCueList
|Read_only=Yes
