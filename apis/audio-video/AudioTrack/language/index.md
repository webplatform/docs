...
|Notes=
===Remarks===
The language tag is not displayed to the user for text tracks. The following example uses the [[apis/audio-video/properties/label|'''label''']] attribute for text to display (such as "English") in the player's track list.
