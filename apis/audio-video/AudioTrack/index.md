...
{{Notes_Section
|Notes=Audio tracks are represented on a '''video''' element as an [[apis/audio-video/AudioTrackList|'''AudioTrackList''']] object, which contains one or more audio tracks.
}}
