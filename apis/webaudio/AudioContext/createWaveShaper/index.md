...
{{API_Name}}
{{Summary_Section|Creates a [[apis/webaudio/WaveShaperNode|WaveShaperNode]], used to apply a distortion effect to audio.}}
{{API_Object_Method
|Parameters=
...
|Return_value_description=WaveShaperNode
}}
{{Examples_Section
|Not_required=No
