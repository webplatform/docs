...
{{Notes_Section
|Notes=If a page is retrieved from an application cache, '''connectEnd''' has the same value as '''fetchStart'''.
...
|URL=http://www.w3.org/TR/resource-timing/#dom-performanceresourcetiming-connectend
