...
|Description=The following example shows how to calculate the time required to redirect the document.
|LiveURL=
|Code=
...
*<code>[[apis/timing/properties/redirectStart|redirectStart]]</code>
}}
