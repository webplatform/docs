...
|Notes=
===Remarks===
If a page is retrieved from an application cache, '''domainLookupEnd''' will have the same value as [[apis/timing/properties/fetchStart|'''fetchStart''']].
...
*<code>[[apis/timing/properties/domainLookupStart|domainLookupStart]]</code>
}}
