...
{{API_Name}}
{{Summary_Section|Creates and returns a new key range with lower set to undefined, lowerOpen set to true, upper set to upper and and upperOpen set to open.}}
{{API_Object_Method
