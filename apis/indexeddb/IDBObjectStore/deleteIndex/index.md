...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=indexName|Data type=DOMString|Description=Name of the index to be deleted.|Optional=}}
...
|Either the associated transaction is not a VERSION_CHANGE transaction.
|-
|name: NotFoundError
