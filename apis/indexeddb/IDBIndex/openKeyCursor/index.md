...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=range|Data type=IDBKeyRange|Description=A key range limiting the cursor to a specific set of values.|Optional=}}
{{Method Parameter|Name=direction|Data type=DOMString|Description=Indicates the direction of traversal and whether duplicate values are included.|Optional=}}
