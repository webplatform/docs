...
{{API_Name}}
{{Summary_Section|Returns a File that represents the current state of the file that this FileEntry represents.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Name=successCallback
|Data type=String
|Description=A callback that is called with the File.
|Optional=No
}}{{Method Parameter
|Name=errorCallback
|Data type=String
...
|Method_applies_to=apis/filesystem/FileEntry
|Example_object_name=FileEntry
