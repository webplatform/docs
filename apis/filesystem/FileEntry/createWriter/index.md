...
{{API_Name}}
{{Summary_Section|Creates a new FileWriter associated with the file that this FileEntry represents.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Index=0
|Name=successCallback
|Data type=String
|Description=A callback that is called with the new FileWriter.
|Optional=No
}}{{Method Parameter
|Index=1
|Name=errorCallback
