...
{{API_Name}}
{{Summary_Section|The file system was successfully obtained.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Name=filesystem
|Data type=String
|Description=The file systems to which the app is granted access.
|Optional=No
}}
|Method_applies_to=apis/filesystem/FileSystemCallback
|Example_object_name=FileSystemCallback
