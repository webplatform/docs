...
{{API_Name}}
{{Summary_Section|Used to supply a FileWriter as a response to a user query.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Name=fileWriter
|Data type=String
|Description=A FileWriter as a response to a user query.
|Optional=No
}}
|Method_applies_to=apis/filesystem/FileWriterCallback
|Example_object_name=FileWriterCallback
