...
{{API_Name}}
{{Summary_Section|Used to supply a File as a response to a user query.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Name=file
|Data type=String
|Description=A File as a response to a user query.
|Optional=No
}}
|Method_applies_to=apis/filesystem/FileCallback
|Example_object_name=FileCallback
