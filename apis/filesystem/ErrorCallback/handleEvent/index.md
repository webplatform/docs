...
{{API_Name}}
{{Summary_Section|There was an error with the request. Details are provided by the err parameter.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Name=err
|Data type=String
|Description=The error that was generated.
|Optional=No
}}
|Method_applies_to=apis/filesystem/ErrorCallback
|Example_object_name=ErrorCallback
