...
{{API_Name}}
{{Summary_Section|Used to supply an Entry as a response to a user query.}}
{{API_Object_Method
|Parameters={{Method Parameter
|Name=entry
|Data type=String
|Description=The Entry to supply as a response to a user query.
|Optional=No
}}
|Method_applies_to=apis/filesystem/EntryCallback
|Example_object_name=EntryCallback
