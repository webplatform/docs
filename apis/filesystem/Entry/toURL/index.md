...
{{Flags
|State=Out of Date
|Editorial notes=Out of date; feature discontinued. See http://www.w3.org/TR/file-system-api/. example
|Checked_Out=No
|High-level issues=Needs Review
}}
{{Standardization_Status|W3C Working Draft}}
{{API_Name}}
{{Summary_Section|Returns a URL that can be used to identify this Entry.
