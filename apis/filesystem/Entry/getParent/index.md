...
{{API_Name}}
{{Summary_Section|Look up the parent DirectoryEntry containing this Entry. If this Entry is the root of its filesystem, its parent is itself.
...
|Data type=String
|Description=A callback that is called to return the parent Entry.
|Optional=No
}}{{Method Parameter
|Index=1
|Name=errorCallback
