...
{{Notes_Section
|Notes====Remarks===
If this event indicates that the resources have been redownloaded,  the script can use [[apis/appcache/methods/swapCache|'''swapCache''']] to switch to the new cache.
