...
{{Flags
|State=Almost Ready
|Editorial notes=Needs example. Needs a list of HTTP return codes: 200, 301, 404, 500, etc.
|Checked_Out=No
|High-level issues=Missing Relevant Sections, Needs Review
}}
{{Standardization_Status|W3C Working Draft}}
{{API_Name}}
{{Summary_Section|Returns the HTTP result code (status) of the response to the request.}}
{{API_Object_Property
