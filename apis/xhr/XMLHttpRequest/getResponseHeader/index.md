...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=bstrHeader|Data type=BSTR|Description='''String''' that specifies the response header name.|Optional=}}
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}203789 XMLHttpRequest], Section 3.7.3
