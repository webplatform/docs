...
|Description=The following example shows how to calculate the time required to load the DOM content for the document.
|LiveURL=
|Code=
var oTiming {{=}} window.performance.timing;
var iTimeMS {{=}} oTiming.domContentLoadedEventEnd - 
              oTiming.domContentLoadedEventEnd;
}}}}
{{Notes_Section
|Notes=
===Remarks===
The value reported by the '''domContentLoadedEventStart''' property represents the number of milliseconds between the recorded time and midnight January 1, 1970 (UTC).
