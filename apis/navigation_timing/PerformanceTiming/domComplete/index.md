...
|Notes=
===Remarks===
The value of the '''domComplete''' property is controlled by the [[dom/document|'''document''']] object associated with the '''window''' object. The value of the '''domComplete''' property is updated when the '''readyState''' property is set to <code>complete</code>.  If the document cannot be loaded, the value of the '''domComplete''' property is available after the [[dom/events/load|'''onload''']] event has finished executing.
