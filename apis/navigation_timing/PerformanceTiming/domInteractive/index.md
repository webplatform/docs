...
{{API_Name}}
{{Summary_Section|Returns the time immediately before the user agent sets the current document readiness to "interactive".}}
{{API_Object_Property
