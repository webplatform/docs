...
{{API_Name}}
{{Summary_Section|Returns the time immediately after the document's DOMContentLoaded event completes.}}
{{API_Object_Property
...
document.write("domContentLoadedEventEnd: " + perftime.domContentLoadedEventEnd + "<br />");</nowiki>
|LiveURL=
}}
}}
{{Notes_Section
|Usage=
|Notes=The value represents the number of milliseconds between midnight January 1, 1970 (UTC) and the recorded ending time.
|Import_Notes=
}}
