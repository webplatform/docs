...
|Description=The following example shows how to calculate the amount of time required to execute the [[dom/events/load|'''onload''']] event for the document.
|LiveURL=
|Code=
...
|Notes=
===Remarks===
The value reported by the [[apis/timing/properties/loadEventEnd|'''loadEventEnd''']] property represents the number of milliseconds between the recorded time and midnight January 1, 1970 (UTC).
...
*<code>[[apis/timing/properties/loadEventEnd|loadEventEnd]]</code>
}}
