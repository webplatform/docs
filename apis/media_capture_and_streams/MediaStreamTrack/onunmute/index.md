...
summary: 'Handles the unmute event when fired on the MediaStreamTrack object.'
tags:
  0: API
  1: Object
  2: Properties
  ...
  6: and
  7: Streams
uri: 'apis/media capture and streams/MediaStreamTrack/onunmute'
...
``` js
var result = track.onunmute;
track.onunmute = value;
```
