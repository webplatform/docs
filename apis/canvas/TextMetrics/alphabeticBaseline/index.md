...
summary: 'The distance from the horizontal line indicated by the textBaseline attribute to the alphabetic baseline of the line box, in CSS pixels; positive numbers indicating that the given baseline is below the alphabetic baseline. (Zero if the given baseline is the alphabetic baseline.)'
tags:
  0: API
  1: Object
  2: Properties
  4: Canvas
uri: apis/canvas/TextMetrics/alphabeticBaseline
...
``` js
var result = TextMetrics.alphabeticBaseline;
```
...
alert("alphabeticBaseline: " + mets.alphabeticBaseline);
