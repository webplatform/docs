...
{{API_Name}}
{{Summary_Section|Creates a new subpath with the specified point as its first (and only) point.}}
{{API_Object_Method
...
|Language=HTML
|Description=This example uses moveTo to establish a subpath starting point, and then uses lineTo to add line segments.
