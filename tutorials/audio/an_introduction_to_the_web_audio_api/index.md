...
We already know about `context`, but what are we going to use `buffer` for? Well, audio buffers are essentially a holding place in memory for sound data. We read data into a buffer from an audio file using an \<a href="[http://www.html5rocks.com/en/tutorials/file/xhr2/](http://www.html5rocks.com/en/tutorials/file/xhr2/)"\>XMLHttpRequest\</a\> like so:
