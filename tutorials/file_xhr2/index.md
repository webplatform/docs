...
A <code>Blob</code> can be used in a number of places, including writing it to the HTML5 [http://docs.webplatform.org/wiki/tutorials/file_filesystem File System], or [http://docs.webplatform.org/wiki/tutorials/workers_basics#BlobURLs creating a Blob URL], as seen in this example.
...
Let's say you have an image gallery and want to fetch a bunch of images then save them locally using the [http://docs.webplatform.org/wiki/tutorials/file_filesystem HTML5 File System]. One way to accomplish this would be to request images as <code>Blob</code>s and write them out using <code>FileWriter</code><nowiki>:</nowiki>
