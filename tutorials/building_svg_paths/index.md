...
As was said in [[Basic Shapes|the previous section]], the shape of a path element is defined by one attribute, <code>d</code>. The <code>d</code> attribute contains a series of commands and parameters used by those commands. So here we're gonna go through the available commands and see on examples, what they do.
