...
**Note :** Icon fonts are another recent popular practice as of 2013 e.g. see [http://css-tricks.com/html-for-icon-font-usage/](http://css-tricks.com/html-for-icon-font-usage/), or [http://nimbupani.com/markup-free-icon-fonts-with-unicode-range.html](http://nimbupani.com/markup-free-icon-fonts-with-unicode-range.html). And then there are very clever OpenType hacks like [Chartwell](https://www.scribbletone.com/typefaces/ff-chartwell) or [Symbolset](http://symbolset.com/). These are part of the scalable arsenal today.
