...
A ''document'' is a collection of information that is structured using a ''markup language''.
    ...
    Examples 
* A web page like the one you are reading is a document.<br>
...
* Dialogs, also called modal windows, of an application are often documents.<br>
       Such dialogs may also be structured using a markup language, like XUL. This is often the case in Mozilla applications, but is not the common case.
...
# Copy and paste the HTML shown below. Save the file using the name <code>doc1.html</code> <pre>
 &lt;!DOCTYPE html&gt;
 &lt;html&gt;
   &lt;head&gt;
   &lt;meta charset="UTF-8"&gt;
