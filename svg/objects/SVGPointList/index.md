...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}204735 Scalable Vector Graphics: Coordinate Systems, Transformations and Units], Section 7.14.2


===Members===
The '''SVGPointList''' object has these types of members:
*[#methods Methods]
*[#properties Properties]


====Methods====
The '''SVGPointList''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''SVGPointList''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
