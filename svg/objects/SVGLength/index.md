...
You can designate an '''SVGLength''' object as read-only, so that attempts to modify the object raises  an <code>NoModificationAllowedError</code> exception.
 
 
...
!Description
|-
|[[svg/properties/unitType  (SVGLength)|'''unitType''']]
