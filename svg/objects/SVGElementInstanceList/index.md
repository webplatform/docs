...
tags:
  ...
  - Objects
  - DOM
uri: svg/objects/SVGElementInstanceList
...
-   [**item**](/svg/methods/item): Gets the specified [**SVGElementInstance**](/svg/objects/SVGElementInstance) object from the collection.

The **SVGElementInstanceList** object has these properties:

-   [**length**](/svg/properties/length): Gets the number of [**SVGElementInstance**](/svg/objects/SVGElementInstance) objects in the list.
