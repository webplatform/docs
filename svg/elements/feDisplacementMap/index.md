...
-   [**xChannelSelector**](/svg/properties/xChannelSelector): Specifies which color channel (R/G/B/A) from image 2 to use for the x displacement property with a **FEDisplacementMap** element.
