...
SVG uses XLink for all link definitions (that is, **xmlns:xlink="[http://www.w3.org/1999/xlink](http://www.w3.org/1999/xlink)"** must be present in the containing [**svg**](/svg/elements/svg) element). Each link associates exactly two resources, one local and one remote, going from the former to the latter.
