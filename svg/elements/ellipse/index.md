...
*[[svg/properties/rx (SVGEllipseElement)|'''rx''']]: Gets or sets the x-axis radius of an ellipse.
*[[svg/properties/ry (SVGEllipseElement)|'''ry''']]: Gets or sets the y-axis radius of an ellipse.
