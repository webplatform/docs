...
|Description=In the following code example, the circle element is used to draw a tomato-colored circle inside an inline SVG element.
Copy this sample to a text file and save it with the .html file extension. Run it in Internet Explorer 9 to see a tomato-colored circle.
...
===Members===
The '''SVGCircleElement''' object has these types of members:
*[#events Events]
*[#methods Methods]
