...
|Import_Notes=
===Syntax===
<code>'''dominant-baseline: '''auto '''{{!}}''' use-script '''{{!}}''' no-change '''{{!}}''' reset-size '''{{!}}''' ideographic '''{{!}}''' alphabetic '''{{!}}''' hanging '''{{!}}''' mathematical '''{{!}}''' central '''{{!}}''' middle '''{{!}}''' text-after-edge '''{{!}}''' text-before-edge '''{{!}}''' inherit</code>
...
*<code>[[svg/attributes/baseline-shift|baselineShift]]</code>
}}
