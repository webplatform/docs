...
|Notes=
===Remarks===
The ratio of miter length (distance between the outer tip and the inner corner of the miter) to [[svg/attributes/stroke-width|'''strokeWidth''']] is directly related to the angle (theta) between the segments in user space by the formula: <code>miterLength / stroke-width {{=}} 1 / sin ( theta / 2 )</code>
|Import_Notes=
===Syntax===
<code>'''stroke-miterlimit: '''inherit</code>
...
*<code>[[svg/attributes/stroke-linejoin|strokeLinejoin]]</code>
