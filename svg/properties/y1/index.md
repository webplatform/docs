...
|Notes=
===Remarks===
The '''y1'''  property represents a ''relative'' coordinate for lowercase [[svg/elements/path|'''path''']] commands (for example, <code>q</code>  and <code>c</code>), and an ''absolute'' coordinate for uppercase '''path''' commands  <code>Q</code> and <code>C</code>.)
|Import_Notes=
===Syntax===
