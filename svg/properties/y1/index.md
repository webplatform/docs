...
The '''y1'''  property represents a ''relative'' coordinate for lowercase [[svg/elements/path|'''path''']] commands (for example, '''q'''  and '''c'''), and an ''absolute'' coordinate for uppercase '''path''' commands  '''Q''' and '''C'''.)
|Import_Notes=
