...
|Notes=
===Remarks===
For JavaScript, the <code>orderY</code> property indicates the number of rows in the [[svg/properties/kernelMatrix|'''kernelMatrix''']]. For HTML, the <code>order</code> attribute is used to set both ''orderX'' and ''orderY'', as described next.
