...
For JavaScript, the '''orderY''' property indicates the number of rows in the [[svg/properties/kernelMatrix|'''kernelMatrix''']]. For HTML, the '''order''' attribute is used to set both ''orderX'' and ''orderY'', as described next.
