...
Returns a stand-alone, parentless quadratic B&eacute;zier curve that is drawn from the current point to the specified point by using relative coordinates.
|Import_Notes=
