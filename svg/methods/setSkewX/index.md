...
The '''setSkewX'''  method can raise a [[dom/DOMException|'''DOMException''']]  exception with the code NO_MODIFICATION_ALLOWED_ERR. This exception is raised  if you try to change the value of a read-only attribute.
|Import_Notes=
