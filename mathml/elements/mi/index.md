...
{{API_Name}}
{{Summary_Section|The MathML '''mi''' element indicates that the content should be rendered as an identifier such as function names, variables or symbolic constants. You can also have arbitrary text in it to mark up terms.}}
{{Markup_Element
...
|Language=HTML
|Description=This example demonstrates a simple usage of the mi element:
...
|Name=MathML 3.0
|URL=http://www.w3.org/TR/MathML3/chapter3.html#presm.mi
...
|Is_CC-BY-SA=No
|Sources=MDN
|MDN_link=https://developer.mozilla.org/en-US/docs/MathML/Element/mi
|MSDN_link=
|HTML5Rocks_link=
}}
== Attributes ==
