...
|Notes=
===Remarks===
The '''COMMENT''' element is treated as a no-scope element and does not expose any [[dom/properties/children (document)+B416|'''children''']].
The '''comment'''.[[dom/properties/length|'''length''']] property, available as of Microsoft Internet Explorer 6, returns the number of characters in the object.
|Import_Notes=
