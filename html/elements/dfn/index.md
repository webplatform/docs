...
|Description=This example uses the '''DFN''' element to indicate a term definition.
|Code=&lt;DFN&gt;HTML stands for hypertext markup language.&lt;/DFN&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''dfn''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''dfn''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''dfn''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''dfn''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
