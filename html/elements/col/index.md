...
{{API_Name}}
{{Summary_Section|The '''col''' element (&lt;col&gt;) specifies  properties for each column within a [[html/element/colgroup|&lt;colgroup&gt;]] element in a [[html/element/table|&lt;table&gt;]].}}
{{Markup_Element
...
===Members===
The '''col''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''col''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''col''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''col''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
