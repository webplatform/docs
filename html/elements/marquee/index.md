...
{{API_Name}}
{{Summary_Section|Defines a scrolling area (usually horizontal) of text.}}
{{Markup_Element
...
====Events====
The '''marquee''' object has these events.
{| class="wikitable"
|-
!Event
!Description
