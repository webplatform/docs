...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 11.2.6
...
===Members===
The '''td''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''td''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''td''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''td''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
|-
|[[html/attributes/abbr|'''abbr''']]
...
|-
|[[dom/properties/cellIndex|'''cellIndex''']]
|Retrieves the position of the object in the [[dom/properties/cellSpacing|'''cells''']] collection of a row.
|-
|[[html/attributes/ch|'''ch''']]
|Sets or retrieves a value that you can use to implement your own [[html/attributes/ch|'''ch''']] functionality for the object.
|-
...
|-
|[[html/attributes/chOff|'''chOff''']]
|Sets or retrieves a value that you can use to implement your own [[html/attributes/chOff|'''chOff''']] functionality for the object.
|-
...
|-
|[[html/attributes/colSpan|'''colSpan''']]
|Sets or retrieves the number columns in the [[html/elements/table|'''table''']] that the object should span.
|-
...
|-
|[[html/attributes/headers|'''headers''']]
...
|-
|[[html/attributes/rowSpan|'''rowSpan''']]
|Sets or retrieves how many rows in a [[html/elements/table|'''table''']] the cell should span.
|-
|[[html/attributes/scope|'''scope''']]
