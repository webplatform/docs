...
{{API_Name}}
{{Summary_Section|"B" is a old tag that tells the browser to make the nested text bold. While the <b> tag is widely supported in browsers, it's use is not recommended as CSS can be used to achieve the same effect.}}
{{Markup_Element
...
===Members===
The '''b''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Methods====
The '''b''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''b''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
