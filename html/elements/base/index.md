...
|Language=HTML
|Description=This example sets the base URL of the document to a reference folder. Internet Explorer uses the '''base''' element to resolve the link to http://msdn.microsoft.com/workshop/author/dhtml
|Code=&lt;html&gt;
&lt;head&gt;
