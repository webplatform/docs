...
{{API_Name}}
{{Summary_Section|Inserts an object into the HTML page.}}
{{Markup_Element
...
|Description=The following example uses the '''script''' element to define event handlers on the '''object''' element.
|Code=&lt;SCRIPT FOR{{=}}oObject EVENT{{=}}eEvent&gt;
:
&lt;/SCRIPT&gt;
&lt;OBJECT ID{{=}}oObject CLASSID{{=}}"xyz.abc"&gt;
&lt;/OBJECT&gt;
}}{{Single Example
|Description=The following example illustrates that when an '''object''' fails to instantiate for any reason, the HTML inside the '''object''' element is rendered. This provides a convenient way to inform the user that the object failed to load.
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 13.3
...
|Retrieves a string of the URL where the object tag can be found. This is often the [[html/attributes/href (base)|'''href''']] of the document that the object is in, or the value set by a '''base''' element.
|-
...
|-
|[[html/attributes/classid|'''classid''']]
...
|-
|[[html/attributes/codeType|'''codeType''']]
...
|-
|[[html/attributes/declare|'''declare''']]
|Sets or retrieves a character string that can be used to implement your own [[html/attributes/declare|'''declare''']] functionality for the object.
|-
...
|-
|[[dom/properties/archive|'''readyState''']]
...
|-
|[[html/attributes/standby|'''standby''']]
