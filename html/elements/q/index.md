...
|Code=&lt;p&gt;He said, &lt;q style{{=}}"font-style: italic"&gt;Hi there!&lt;/q&gt;&lt;/p&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
Windows Internet Explorer 8 and later. The value of the [[html/attributes/cite|'''cite''']] attribute depends on the current document compatibility mode. In addition, quotation marks are now added to the content of the element.
...
===Members===
The '''q''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Methods====
The '''q''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''q''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
