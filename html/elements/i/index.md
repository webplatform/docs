...
|Description=This example uses the '''I''' element to make the text appear in italic type.
...
===Members===
The '''i''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Methods====
The '''i''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''i''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
