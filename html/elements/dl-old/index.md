...
{{API_Name}}
{{Summary_Section|The <code>&lt;dl&gt;</code> element is used to define a '''description list'''. The element encloses one or more '''description terms''', enclosed in [[html/elements/dt|<code>&lt;dt&gt;</code>]] elements, and '''description definitions''' (definitions of the terms), enclosed within [[html/elements/dd|<code>&lt;dd&gt;</code>]] elements.<b>bold</b>
; Permitted&#160;contents
...
====Methods====
The '''dl''' object has these methods.
{{{!}} class="wikitable"
{{!}}-
!Method
!Description
...
{{!}}-
{{!}}[[html/attributes/compact{{!}}'''compact''']]
