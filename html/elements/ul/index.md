...
{{API_Name}}
{{Summary_Section|Defines an unordered list, usually bulleted.}}
{{Markup_Element
...
===Members===
The '''ul''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''ul''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''ul''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''ul''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[html/attributes/type (ul,li,ol elements)|'''type''']]
