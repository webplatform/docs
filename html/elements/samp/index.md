...
|Code=&lt;SAMP&gt;Here is some text in a small fixed-width font.&lt;/SAMP&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''samp''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''samp''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''samp''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''samp''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
