...
{{API_Name}}
{{Summary_Section|Defines important text. Renders as bold.}}
{{Markup_Element
...
|Description=This example uses the '''STRONG''' element to make text appear bold.
|Code=&lt;STRONG&gt;This text is strongly emphasized (shown as bold).&lt;/STRONG&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''strong''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''strong''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''strong''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''strong''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
