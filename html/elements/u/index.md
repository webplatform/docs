...
{{Flags
|State=Not Ready
|Editorial notes=Add description, notes, example.
|Checked_Out=No
...
|Description=This example uses the '''U''' element to underline text.
|Code=&lt;U&gt;This text is underlined.&lt;/U&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''u''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Methods====
The '''u''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''u''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|Name=HTML 5.1
|URL=http://www.w3.org/TR/html51/text-level-semantics.html#the-u-element
...
|Name=HTML 4.01
|URL=http://www.w3.org/TR/html401/present/graphics.html#edef-U
|Status=W3C Recommendation
|Relevant_changes=
}}
}}
