...
|Language=HTML
|Description=この例ではテキストを正しく読める向きに表示するために'''bdo'''要素を使っています。正しく読める順番で書いたテキストを[[html/attributes/dir/ja|'''dir''']]属性に'''ltr'''を指定した'''bdo'''タグの間に記述することで双方向アルゴリズムを無効化することができます。
