...
| It's deprecated: http://www.w3.org/TR/html5/obsolete.html#non-conforming-features
}}
}}
...
|Description=This example uses the '''BIG''' element to enlarge text.
|Code=&lt;BIG&gt;This text is larger&lt;/BIG&gt; than this text.
}}
}}
{{Notes_Section
|Notes====Remarks===
