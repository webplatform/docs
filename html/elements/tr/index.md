...
===Members===
The '''tr''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''tr''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''tr''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
|-
|[[dom/methods/deleteCell|'''deleteCell''']]
|Removes the specified cell ('''td''') from the table row, as well as from the [[dom/properties/cellSpacing|'''cells''']] collection.
|-
...
|-
|[[dom/methods/insertCell|'''insertCell''']]
|Creates a new cell in the table row ('''tr'''), and adds the cell to the [[dom/properties/cellSpacing|'''cells''']] collection.
|-
...
====Properties====
The '''tr''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[dom/properties/rowIndex|'''rowIndex''']]
|Retrieves the position of the object in the [[dom/properties/rows (table)|'''rows''']] collection for the [[html/elements/table|'''table''']].
|-
|'''scopeName'''
...
|-
|[[dom/properties/sectionRowIndex|'''sectionRowIndex''']]
|Retrieves the position of the object in the '''tBody''', '''tHead''', '''tFoot''', or [[dom/properties/rows (table)|'''rows''']] collection.
|-
