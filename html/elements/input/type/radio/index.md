...
===Members===
The '''input type{{=}}radio''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''input type{{=}}radio''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''input type{{=}}radio''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''input type{{=}}radio''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
