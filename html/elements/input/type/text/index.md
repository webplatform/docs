...
{{API_Name}}
{{Summary_Section|The input element with a type attribute whose value is "text" represents a one-line plain text edit control for the input element’s value.}}
{{Markup_Element
...
{{See_Also_Section
|External_links=http://www.w3.org/TR/html-markup/input.text.html#input.text
