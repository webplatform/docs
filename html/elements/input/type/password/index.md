...
{{Flags
|State=Not Ready
|Editorial notes=Merge Candidate: html/attributes/type. Add example, and more contents.
|Checked_Out=No
...
{{API_Name}}
{{Summary_Section|The '''password''' type of the [[html/elements/input|&lt;input&gt;]] element represents a one-line plain-text edit control for entering a password, which renders input text in such a way as to hide the characters (e.g., a series of asterisks).}}
{{Markup_Element
...
===Members===
The '''input type{{=}}password''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''input type{{=}}password''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''input type{{=}}password''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''input type{{=}}password''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[html/attributes/vcard_name|'''vcard_name''']]
|Sets or retrieves the <code>vCard</code> value of the object to use for the AutoComplete box.
|-
