...
{{Flags
|State=Not Ready
|Editorial notes=Merge Candidate: html/attributes/type. Add example.
|Checked_Out=No
...
===Members===
The '''input type{{=}}image''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''input type{{=}}image''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''input type{{=}}image''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''input type{{=}}image''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
