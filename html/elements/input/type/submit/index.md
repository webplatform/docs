...
{{API_Name}}
{{Summary_Section|An input form button that submits the form data to the server.}}
{{Markup_Element
...
===Members===
The '''input type{{=}}submit''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''input type{{=}}submit''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''input type{{=}}submit''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''input type{{=}}submit''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
