...
|Description=This example uses the '''SUB''' element to change some of the text to a subscript font.
|Code=(X&lt;SUB&gt;1&lt;/SUB&gt;,Y&lt;SUB&gt;1&lt;/SUB&gt;)
}}
}}
{{Notes_Section
|Notes====Remarks===
|Import_Notes====Standards information===
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 9.2.3
...
===Members===
The '''sub''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''sub''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''sub''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''sub''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
