...
{{API_Name}}
{{Summary_Section|Indicates text that has been deleted from the document. Browsers will normally strike a line through deleted text.}}
{{Markup_Element
...
|Description=This example uses the '''DEL''' element to mark deleted text.
|Code=&lt;del&gt;This text has been revised.&lt;/del&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
Windows Internet Explorer 8 and later. The value of the [[html/attributes/cite|'''cite''']] attribute depends on the current document compatibility mode.
|Import_Notes====Standards information===
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 9.4
...
===Members===
The '''del''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''del''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''del''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
|-
|[[html/attributes/dateTime|'''dateTime''']]
