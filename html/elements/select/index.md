...
===Members===
The '''select''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''select''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''select''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
|-
|[[dom/methods/add|'''add''']]
|Adds an element to the [[dom/properties/areas|'''areas''']], [[dom/properties/controlRange|'''controlRange''']], or [[dom/properties/options|'''options''']] collection.
|-
|'''addBehavior'''
...
|-
|[[dom/methods/item (Options, Select)|'''item''']]
|Retrieves a '''select''' object or an object from an [[dom/properties/options|'''options''']] collection.
|-
...
|-
|[[dom/methods/namedItem (Options, Select)|'''namedItem''']]
|Retrieves a '''select''' object or an object from an [[dom/properties/options|'''options''']] collection.
|-
...
|-
|[[dom/properties/selectedIndex|'''selectedIndex''']]
|Sets or retrieves the index of the selected option in a '''select''' object.
|-
|[[dom/traversal/properties/size|'''size''']]
...
|-
|[[html/attributes/type (select element)|'''type''']]
|Retrieves the type of '''select''' control based on the value of the [[html/attributes/multiple|'''MULTIPLE''']] attribute.
|-
