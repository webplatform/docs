...
|Description=This example uses the '''TT''' element to render text in a fixed-width font.
|Code=&lt;TT&gt;Here's some plain text.&lt;/TT&gt;
}}
}}
{{Notes_Section
...
===Members===
The '''tt''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''tt''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''tt''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''tt''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
