...
{{API_Name}}
{{Summary_Section|Denotes one item in a list.}}
{{Markup_Element
...
===Members===
The '''li''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''li''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''li''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''li''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[html/attributes/value (li element)|'''value''']]
