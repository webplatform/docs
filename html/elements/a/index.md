...
===Members===
The '''a''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Methods====
The '''a''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''a''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|Sets or retrieves the subsection of the [[html/attributes/href|'''href''']] property that follows the number sign (#).
|-
...
|-
|[[dom/properties/host|'''host''']]
|Sets or retrieves the [[dom/properties/hostname|'''hostname''']] and [[dom/properties/port|'''port''']] number of the location or URL.
|-
|[[dom/properties/hostname|'''hostname''']]
...
|-
|[[html/attributes/methods|'''Methods''']]
...
|-
|[[dom/properties/pathname|'''pathname''']]
...
|-
|[[dom/properties/search|'''search''']]
|Sets or retrieves the substring of the [[dom/properties/href|'''href''']] property that follows the question mark.
|-
|[[html/attributes/shape|'''shape''']]
...
|-
|[[html/attributes/type type (a, link, embed)|'''type''']]
