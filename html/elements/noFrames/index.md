...
{{API_Name}}
{{Summary_Section|Provides content for browsers that cannot, or are configured not to, display frames.}}
{{Markup_Element
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 16.4.1
