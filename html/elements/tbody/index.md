...
====Methods====
The '''tBody''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
|Deletes the '''tFoot''' element and its contents from the [[html/elements/table|'''table''']].
|-
|[[dom/methods/deleteTHead|'''deleteTHead''']]
|Deletes the '''tHead''' element and its contents from the [[html/elements/table|'''table''']].
|-
...
====Properties====
The '''tBody''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
