...
{{Notes_Section
|Usage=Every HTML document must have a TITLE element in the HEAD section.

You can only have one title element on your page. This tag is mandatory. If you omit it the document will not validate as HTML
|Notes====Remarks===
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 7.4.2
