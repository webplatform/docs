...
|Description=This example uses the '''center''' element to center text on a page.
|LiveURL=
|Code=
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 15.1.3 (Deprecated)
...
===Members===
The '''center''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''center''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''center''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''center''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
