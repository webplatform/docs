...
{{Flags
|State=Not Ready
|Editorial notes=Add example, note section.
|Checked_Out=No
...
|Description=This example uses the '''VAR''' element to render the word "filename" in italic type.
|Code=Enter the &lt;VAR&gt;filename&lt;/VAR&gt; in the dialog box.
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''var''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''var''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''var''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''var''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|Name=HTML 5.1
|URL=http://www.w3.org/TR/html51/text-level-semantics.html#the-var-element
...
|Name=HTML 4.01
|URL=http://www.w3.org/TR/html401/struct/text.html#edef-VAR
|Status=W3C Recommendation
|Relevant_changes=
}}
}}
