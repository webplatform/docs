...
{{Flags
|State=In Progress
|Editorial notes=Add Compatibility. Need to clean up.
|Checked_Out=No
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 17.9.1
...
===Members===
The '''label''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''label''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''label''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''label''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[html/attributes/dom/for|'''htmlFor''']]
