...
|Description=This example uses the '''TEXTAREA''' element to set the cascading style sheets (CSS) [[css/properties/overflow|'''overflow''']] attribute to "hidden" to remove the scroll bars from the '''TEXTAREA'''.
|LiveURL=
|Code=
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 17.7
...
===Members===
The '''textArea''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''textArea''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''textArea''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
|-
|[[dom/methods/setSelectionRange|'''setSelectionRange''']]
...
====Properties====
The '''textArea''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[html/attributes/cols (TextArea element)|'''cols''']]
...
|-
|[[dom/properties/rows (textArea)|'''rows''']]
...
|-
|[[html/attributes/type (textarea element)|'''type''']]
...
|-
|[[html/attributes/value (textarea element)|'''value''']]
|Retrieves or sets the text in the entry field of the '''textArea''' element.
|-
|[[html/attributes/wrap|'''wrap''']]
