...
===Members===
The '''img''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''img''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''img''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''img''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|-
|[[dom/properties/fileCreatedDate|'''fileCreatedDate''']]
|Retrieves the date the file was created.
|-
|[[dom/properties/fileModifiedDate|'''fileModifiedDate''']]
|Retrieves the date the file was last modified.
|-
|[[dom/properties/fileSize|'''fileSize''']]
|Retrieves the file size.
|-
|[[dom/properties/fileUpdatedDate|'''fileUpdatedDate''']]
...
|-
|'''nameProp'''
|Retrieves the file name specified in the [[html/attributes/href|'''href''']] or [[html/attributes/src (iframe, embed, xml)|'''src''']] property of the object.
|-
|[[dom/properties/namespaceURI|'''namespaceURI''']]
|Retrieves the namespace URI of the fully qualified XML declaration for a node.
|-
|[[dom/properties/naturalHeight|'''naturalHeight''']]
|The original height of the image resource before sizing.
|-
|[[dom/properties/naturalWidth|'''naturalWidth''']]
...
|Sets or retrieves the [[dom/properties/URL|'''URL''']] of the VRML world to be displayed in the window.
|-
...
|Name=HTML5
|URL=http://dev.w3.org/html5/markup/img.html#img
...
*<code>How to Apply a Transition on an Image</code>
*<code>Other Resources</code>
*<code>[http://go.microsoft.com/fwlink/p/?linkid{{=}}204339 Build Flexible, Lightweight XML-Based Images for ASP.NET Using Scalable Vector Graphics]</code>
}}
{{Topics|HTML}}
