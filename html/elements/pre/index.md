...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 9.3.4
...
===Members===
The '''pre''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''pre''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''pre''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''pre''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|Sets or gets a value that you can use to implement your own [[html/attributes/width|'''width''']] functionality for the object.
|}
 
