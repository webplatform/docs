...
{{API_Name}}
{{Summary_Section|Defines inline text that will appear small. Used for fine print.}}
{{Markup_Element
...
|Description=This example uses the '''SMALL''' element to display text in a smaller font.
|Code=&lt;SMALL&gt;This text is smaller&lt;/SMALL&gt; than this text.
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''small''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''small''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''small''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''small''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
...
|Name=HTML 5.1
|URL=http://www.w3.org/TR/html51/text-level-semantics.html#the-small-element
...
|Name=HTML 4.01
|URL=http://www.w3.org/TR/html401/present/graphics.html#edef-SMALL
|Status=W3C Recommendation
|Relevant_changes=
}}
}}
