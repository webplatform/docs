...
|-
|[[dom/properties/defaults|'''defaultSelected''']]
...
|-
|[[html/attributes/label|'''label''']]
|Sets or retrieves a value that you can use to implement your own [[html/attributes/label|'''label''']] functionality for the object.
|-
...
This property is not supported for Metro style apps using JavaScript.
|-
|[[dom/properties/text (Option element)|'''text''']]
