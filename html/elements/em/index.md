...
|Code=&lt;EM&gt;This text will be emphasized in some way (most likely in italic).&lt;/EM&gt;
}}
}}
{{Notes_Section
|Notes====Remarks===
...
===Members===
The '''em''' object has these types of members:
*[#events Events]
*[#methods Methods]
...
====Events====
The '''em''' object has these events.
{| class="wikitable"
|-
!Event
!Description
...
====Methods====
The '''em''' object has these methods.
{| class="wikitable"
|-
!Method
!Description
...
====Properties====
The '''em''' object has these properties.
{| class="wikitable"
|-
!Property
!Description
