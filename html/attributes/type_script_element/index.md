...
{{Notes_Section
|Notes====Remarks===
Compare this property with the [[html/attributes/language|'''language''']] property. To avoid conflict, match the '''type''' with the language type specified in the '''language''' property.
|Import_Notes====Syntax===
}}
