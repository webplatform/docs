...
|Description=This example uses the '''TYPE''' attribute to set the line item markers to lowercase Roman numerals.
|Code=&lt;OL TYPE{{=}}"i"&gt;
&lt;LI&gt;First Item
&lt;LI&gt;Second Item
&lt;LI&gt;Third Item
&lt;/OL&gt;
|LiveURL=http://samples.msdn.microsoft.com/workshop/samples/author/dhtml/refs/type.htm
}}
}}
{{Notes_Section
|Import_Notes====Syntax===
