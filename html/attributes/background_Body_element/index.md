...
{{API_Name}}
{{Summary_Section|Specifies a background image for a document. This attribute is deprecated in HTML4 and not supported in HTML5. Use CSS.}}
{{Markup_Attribute
...
{{Notes_Section
|Notes====Remarks===
This property is deprecated in favor of the [[css/properties/background-image|'''background-image''']] attribute of CSS.
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}25320 HTML 4.01 Specification], Section 7.5.1 (Deprecated)
}}
...
*<code>body</code>
*<code>Reference</code>
*<code>[[css/properties/background-image|backgroundImage]]</code>
