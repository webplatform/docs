...
{{Notes_Section
|Notes====Remarks===
The following example shows the use of the '''min''', [[html/attributes/max (HTMLInputElement)|'''max''']], and [[html/attributes/step|'''step''']] attributes.
...
*[http://go.microsoft.com/fwlink/p/?linkid{{=}}221374 HTML5 A vocabulary and associated APIs for HTML and XHTML], Section 4.10.7.3.10
}}
...
*<code>[[html/attributes/max (HTMLInputElement)|Max]]</code>
}}
{{Topics|HTML}}
