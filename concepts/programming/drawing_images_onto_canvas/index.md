...
Now letâ€™s turn this fileâ€™s content into a data URL that we can use as the source for our image. After the image has loaded, we donâ€™t need the data URL any more and we will free the memory.
