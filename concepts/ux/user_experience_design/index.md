...
{{Summary_Section}}
{{Concept_Page
|Content=Designing a website is not about finding pretty colors and using nice fonts. No, it's not. A website provides services, contents and/or informations to its users. So, it should not be build for your own pleasure but to meet the needs of its users. Taking care of them by designing a tool usable, understandable and meeting your and their expectation, that is conceive a User eXperience design. 
