...
![successful request response cycle](//static.webplatform.org/6/62/article3.gif)
...
![an image of an HTML page without and with CSS applied](//static.webplatform.org/6/6e/article4.gif)
