...
[[Image:article3.gif|center|successful request response cycle|Figure 1: In this case, everything is fine, and the server returns the correct web page.   If something goes wrong, for example you typed the URL incorrectly, you’ll get an '''HTTP error''' returned to your web browser instead — the infamous 404 '''page not found''' error is the most common example you’ll come across.]]
