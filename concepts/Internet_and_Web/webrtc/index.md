...
[[Image:bowser.png|The Ericsson Bowser browser running on iOS and Android]] The Ericsson Bowser browser running on iOS and Android  
...
[[Image:jsep.png|JSEP architecture diagram]] JSEP architecture  
...
[http://www.webrtc.org/reference/architecture [[Image:webrtcArchitecture.png|WebRTC architecture diagram]]] WebRTC architecture (from [http://www.webrtc.org/reference/architecture webrtc.org])  
...
[[Image:stun.png|Finding connection candidates]] Finding connection candidates  
...
[[Image:dataPathways.png|WebRTC data pathways]] WebRTC data pathways  
...
[[Image:apprtcArchitecture.png|Architecture of the apprtc video chat application]] Architecture of the apprtc video chat application  
...
[[Image:channelEstablishing.png|The Google Channel API: establishing a channel]] The Google Channel API: establishing a channel  
...
[[Image:channelSending.png|The Google Channel API: sending a message]] The Google Channel API: sending a message  
...
[[Image:tethr.jpg|Tethr/Tropo demo at Google I/O 2012]] Tethr/Tropo demonstration at Google I/O 2012  
...
[[Image:firefoxDataChannel.png|Firefox RTCDataChannel screenshot]] RTCDataChannel running in Firefox Nightly  
