...
There are inspectors for both desktop-level structures and web-level object models. On the desktop-level side of things, OS X comes with [http://developer.apple.com/documentation/Accessibility/Conceptual/AccessibilityMacOSX/OSXAXTesting/chapter_5_section_2.html Accessibility Inspector] and [http://developer.apple.com/documentation/Accessibility/Conceptual/AccessibilityMacOSX/OSXAXTesting/chapter_5_section_3.html Accessibility Verifier]. Microsoft provides the [http://www.microsoft.com/en-us/download/details.aspx?id=20480 Digital Lens] inspector tool, which provides UI designers and developers the tools to view the visual design as it would be seen by vision impaired users. [http://live.gnome.org/Accerciser Accerciser] is available for the GNOME assistive technology-SPI API.
