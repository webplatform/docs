...
**Language:**
:   ****English****  • <span lang="es">[español](/css/es)</span> • <span lang="fr">[français](/css/fr)</span> • <span lang="ko">[한국어](/css/ko)</span> • <span lang="zh">[中文](/css/zh)</span>
...
CSS allows you to style your content through a set of [selectors](/css/selectors) and [properties](/css/properties).

-   First version: The [CSS 1 recommendation](http://www.w3.org/TR/REC-CSS1/) was described by Håkon Wium Lie and Bert Bos, and first published in 1996.
...
-   [media queries](/css/media_queries)
...
-   [cue-after](/css/properties/cue-after)
...
-   [marquee-style](/css/properties/marquee-style)
...
-   [unicode-range](/css/properties/unicode-range)
