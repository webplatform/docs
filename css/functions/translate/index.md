...
{{API_Name}}
{{Summary_Section|[[css/properties/transform|Transform]] function for a 2d transformation which sets the position of an element to a new one, described by two vectors (x, y). The y value is optional.}}
{{CSS_Function
|Content===Syntax==
