...
|Description=The following code snippet is an example of the '''scaleY''' function in use. When applied to a square blue [[html/elements/div|'''div''']] element, it has the effect illustrated in the image. (The light-blue square indicates the original position of the transformed element.)
|LiveURL=
|Code=
div {    
