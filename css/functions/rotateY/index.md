...
{{API_Name}}
{{Summary_Section|Rotates an element around its Y-axis at a given degree.}}
{{CSS_Function
|Content=
}}
{{Examples_Section
...
|Language=CSS
|Description=The following code snippet is an example of the '''rotateY''' function in use as applied to a square blue [[html/elements/div|'''div''']] element along with the [[css/functions/perspective()|'''perspective''']] function (which simulates depth).
|Code=div {
