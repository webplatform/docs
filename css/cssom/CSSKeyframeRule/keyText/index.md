...
notes:
  - 'does not provide much more elaboration than syntax reference. a basic definition of the term ''keytext'' would help.'
readiness: 'In Progress'
relationships:
  applies_to:
    predicate: 'Property of '
    value: css/cssom/CSSKeyframeRule
    href: /css/cssom/CSSKeyframeRule
tags:
  - API_Object_Properties
  - DOM
  - Needs_Summary
  - Needs_Examples
uri: css/cssom/CSSKeyframeRule/keyText
...
``` js
var result = element.keyText;
element.keyText = value;
```
...
-   CSSKeyframeRule[CSSKeyframeRule](/css/cssom/CSSKeyframeRule)
