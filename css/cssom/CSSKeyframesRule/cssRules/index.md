...
notes:
  - 'remove duplicate Syntax header, include summary with definition and examples.'
uri: css/cssom/CSSKeyframesRule/cssRules
...
<span data-meta="applies_to" data-type="key">Property of <span data-type="value">[css/cssom/CSSKeyframeRule](/css/cssom/CSSKeyframeRule)</span></span>

## Syntax

``` {.js}
var result = element.cssRules;
element.cssRules = value;
```
