...
{{Flags
|State=In Progress
|Editorial notes=does not provide much more elaboration than syntax reference. perhaps include mention of the MediaList object and a working definition of 'media' in relation to the CSSOM
|Checked_Out=No
...
{{Summary_Section}}
{{API_Object_Property
|Property_applies_to=css/cssom/CSSImportRules
|Read_only=No
}}
{{Examples_Section
|Not_required=No
