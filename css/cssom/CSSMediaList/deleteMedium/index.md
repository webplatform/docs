...
notes:
  - 'Perhaps we need a link to "medium" to describe the term, then add these functions as subsections? In either case, a link or short definition would help, or brief examples.'
...
summary: 'Deletes a medium from the current list.'
tags:
  - API_Object_Methods
  - DOM
  - Needs_Examples
uri: css/cssom/CSSMediaList/deleteMedium
...
``` js
 mediaList.deleteMedium(/* see parameter list */);
```
...
-   item[item](/css/cssom/CSSMediaList/item)
