...
{{Flags
|State=Almost Ready
|Editorial notes=include examples of appropriate and inappropriate mediums, or provide range of accepted values for mediums.
|Checked_Out=No
...
|Name=medium
|Data type=String
|Description=The new medium to add.
|Optional=No
}}
