...
tags:
  ...
  - Methods
  - DOM
uri: 'css/media queries/apis/handleChange'
...
``` js
var object = object.handleChange();
```
...
-   MediaQueryListListener[MediaQueryListListener](/css/media_queries/apis/MediaQueryListListener)
