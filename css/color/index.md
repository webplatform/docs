...
Note that the system color names have been deprecated in the [http://www.w3.org/TR/css3-color/](http://www.w3.org/TR/css3-color/) CSS Color Module Level 3] recommendation, and since they are Windows-only, so it is advisable to not use them.
