...
{{API_Name}}
{{Summary_Section|Transforms are a css property and associated functions that allows a developer to translate, rotate, skew, and scale elements. By carefully defining functions and associated CSS properties, a developer can hack together a pretty complex 3d looking scene.}}
{{API_Object_Property
|Property_applies_to=css/transforms
|Read_only=No
}}
{{Examples_Section
|Not_required=No
