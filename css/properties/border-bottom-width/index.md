...
code_samples:
  - 'http://code.webplatform.org/gist/5550463'
compatibility:
  feature: border-bottom-width
  topic: css
notes:
...
<h2>Summary</h2>
<p>
Sets the width of an element's bottom border. To set all four borders, use the border-width shorthand property which sets the values simultaneously for border-top-width, border-right-width, border-bottom-width, and border-left-width.</p>
...
<dl><dt><a href="/css/concepts/initial_value"> Initial value</a></dt>
  ...
  <dd><code>borderBottomWidth</code></dd>
</dl><dl><dt>Percentages</dt>
  <dd>N/A</dd>
</dl><h2>Syntax</h2>
<ul><li>

<code>border-bottom-width: &lt;width&gt;</code>
</li>
	<li>

<code>border-bottom-width: medium</code>
</li>
	<li>

<code>border-bottom-width: thick</code>
</li>
	<li>

<code>border-bottom-width: thin</code>
</li>
</ul><p><br/></p>
<h2>Values</h2>
<dl><dt>medium</dt>
...
<p><a rel="nofollow" class="external text" href="http://code.webplatform.org/gist/5550463">View live example</a>
</p>
</div>
<p><br/></p><p><br/></p>
<h2>Related specifications</h2>

<dl><dt><a rel="nofollow" class="external text" href="http://www.w3.org/TR/css3-background/#border-width">CSS Level 3 - Backgrounds and Borders Module</a></dt>
...
<ul><li> <strong class="selflink">border-bottom-width</strong></li></ul><p><br/></p>
