...
code_samples:
  - 'http://code.webplatform.org/gist/5550425'
compatibility:
  feature: border-right-width
  topic: css
notes:
...
overview_table:
  ...
  Animatable: 'No'
  '[CSS Object Model Property](/css/concepts/cssom)': '`borderRightWidth`'
  Percentages: N/A
readiness: 'Ready to Use'
standardization_status: 'W3C Candidate Recommendation'
summary: 'Sets the width of an element''s right border. To set all four borders, use the border-width shorthand property which sets the values simultaneously for border-top-width, border-right-width, border-bottom-width, and border-left-width.'
tags:
  - CSS_Properties
  - CSS
uri: css/properties/border-right-width
...
<h2>Summary</h2>
<p>
Sets the width of an element's right border. To set all four borders, use the border-width shorthand property which sets the values simultaneously for border-top-width, border-right-width, border-bottom-width, and border-left-width.</p>
...
<dl><dt><a href="/css/concepts/initial_value"> Initial value</a></dt>
  ...
  <dd><code>borderRightWidth</code></dd>
</dl><dl><dt>Percentages</dt>
  <dd>N/A</dd>
</dl><h2>Syntax</h2>
<ul><li>

<code>border-right-width: &lt;width&gt;</code>
</li>
	<li>

<code>border-right-width: medium</code>
</li>
	<li>

<code>border-right-width: thick</code>
</li>
	<li>

<code>border-right-width: thin</code>
</li>
</ul><p><br/></p>
<h2>Values</h2>
<dl><dt>medium</dt>
...
<p><a rel="nofollow" class="external text" href="http://code.webplatform.org/gist/5550425">View live example</a>
</p>
</div>
<p><br/></p><p><br/></p>
...
<ul><li> <strong class="selflink">border-right-width</strong></li></ul><p><br/></p>
