...
{{CSS_Property_Value|Data Type=percentage |Description=An integer, followed by a percent sign (%). The value is a percentage of, for horizontal radii, the width of the border box, or for vertical radii, the height of the border box.}}
}}
{{Topics|CSS}}
{{Notes_Section
|Notes=
