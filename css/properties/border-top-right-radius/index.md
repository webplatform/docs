...
{{API_Name}}
{{Summary_Section|Defines the shape of the border of the top-right corner.}}
{{CSS Property
|Initial value=0
...
|Code=border-top-right-radius: 10px;
...
|Code=border-top-right-radius: 10px 5px;
}}{{Single Example
|Language=CSS
...
|Code=border-top-right-radius: 30%;
}}
}}
{{Notes_Section
|Notes====Remarks===
