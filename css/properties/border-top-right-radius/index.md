...
{{Flags
|State=In Progress
|Editorial notes=Complete example, summery.
|Checked_Out=No
}}
{{Standardization_Status|W3C Candidate Recommendation}}
{{API_Name}}
{{Summary_Section|Sets the rounding of the top-right corner of the element.}}
{{CSS Property
|Initial value=0
...
|Animatable=Yes
|CSS object model property=borderTopRightRadius
...
|LiveURL=http://code.webplatform.org/gist/6950234
}}
}}
{{Notes_Section
|Notes====Remarks===
...
|Name=CSS Backgrounds and Borders Module Level 3; 5.1. Curve Radii: the ‘border-radius’ properties
|URL=http://dev.w3.org/csswg/css-backgrounds/#border-top-right-radius
...
|Version=9.0
|Note=The border-top-right-radius property can't be animated/transitioned in IE.
}}
}}
{{See_Also_Section
...
|Is_CC-BY-SA=No
|Sources=MDN, MSDN
|MDN_link=[https://developer.mozilla.org/es/docs/CSS/border-top-right-radius Border-top-right-radius]
