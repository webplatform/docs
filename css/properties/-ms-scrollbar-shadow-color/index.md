...
|Description=The following example shows how to create a style rule that sets the '''-ms-scrollbar-shadow-color''' property for a '''textArea''' element.
...
|Import_Notes=
===Syntax===
<code>'''-ms-scrollbar-shadow-color: '''variant</code>
