...
{{API_Name}}
{{Summary_Section|Specifies the line colors for the line-through text decoration.

(Considered obsolete; use [[css/properties/text-decoration-color|text-decoration-color]] instead.)
}}
{{CSS Property
...
{{Notes_Section
|Notes=To learn more about the initial value, see [[css/color#currentColor|currentColor]].

This property is obsolete and has been replaced by the  [[css/properties/text-decoration-color|text-decoration-color]] property. 
