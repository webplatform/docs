...
|Inherited=No
|Initial value=0
|Values={{CSS_Property_Value|Data Type=margin-width |Description=Default. Bottom margin is set equal to the top margin.}}
...
|Code=
&lt;IMG src{{=}}"sphere.jpg"onmouseover{{=}}"this.style.marginBottom{{=}}'1cm'"&gt;
}}}}
{{Notes_Section
|Notes=
===Remarks===
