...
|Inherited=Yes
|Initial value=
|Values={{CSS_Property_Value|Data Type=ltr |Description=Default. Content flows left to right.}}
{{CSS_Property_Value|Data Type=rtl |Description=Content flows right to left.}}
}}
{{Topics|CSS}}
{{Examples_Section
|Not_required=No
