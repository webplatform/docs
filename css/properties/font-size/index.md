...
|Name=larger, smaller
|DescriptionLarger or smaller than the parent element's font size, by roughly the ratio used to separate the absolute size keywords above.
}}{{CSS Property Value
|Name=length
...
|Syntax=font-size: xx-small | x-small | small | medium | large | x-large | xx-large
