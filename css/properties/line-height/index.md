...
{{API_Name}}
{{Summary_Section|The line-height property specifies the amount of leading space added before and after an inline block level element. The line-height value will specify the exact block dimension of each box generated by the element. The value of the line-height property cannot be negative.}}
{{CSS Property
