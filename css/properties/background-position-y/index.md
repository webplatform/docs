...
|Content=Not Neutral, Cleanup, Compatibility Incomplete, Examples Best Practices
}}
...
|Import_Notes====Syntax===
<code>'''-ms-background-position-y: '''length '''{{!}}''' percentage '''{{!}}''' vAlignment</code>
...
*<code>[[css/properties/background-position-x|-ms-background-position-x]]</code>
}}
{{Topics|CSS}}
