...
|Inherited=No
|Initial value=
|Values={{CSS_Property_Value|Data Type=color |Description=One of the color names or RGB values in the Color Table.}}
{{CSS_Property_Value|Data Type=transparent |Description=Fully transparent. This keyword can be considered a shorthand for transparent black, rgba(0,0,0,0), which is its computed value.}}
{{CSS_Property_Value|Data Type=inherit |Description=Use value inherited from parent object.}}
}}
{{Topics|CSS}}
{{Examples_Section
|Not_required=No
