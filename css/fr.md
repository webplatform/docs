...
CSS vous permet de styliser vos contenus avec un ensemble de [sélecteurs](/css/selectors) et de [propriétés](/css/properties).

-   Première version : La [Recommandation CSS 1](http://www.w3.org/TR/REC-CSS1/) décrite par Håkon Wium Lie et Bert Bos, publiée pour la première fois en 1996.
