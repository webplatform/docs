...
|Description=The following  code example shows the relationship between the [[dom/properties/target|'''target''']] and '''data''' properties of a processing instruction object.
|LiveURL=
|Code=
...
For  this example, the '''data''' property would return <code>type{{=}}'text/css' href{{=}}'style.css'</code>.
|Import_Notes=
===Syntax===
...
*<code>[[dom/properties/target|target]]</code>
}}
