...
the first child node in the filtered [[dom/traversal/TreeWalker|'''TreeWalker''']] hierarchy.|Optional=}}
...
the first child node in the filtered [[dom/traversal/TreeWalker|'''TreeWalker''']] hierarchy.
...
|Notes=
===Remarks===
'''firstChild''' sets the [[dom/traversal/properties/currentNode|'''currentNode''']] to the returned node.
|Import_Notes=
===Syntax===
