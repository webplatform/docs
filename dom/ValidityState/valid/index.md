...
{{API_Name}}
{{Summary_Section|Returns whether the input field value has any validity errors.}}
{{API_Object_Property
|Property_applies_to=dom/ValidityState
|Read_only=Yes
|Example_object_name=validityState
|Return_value_name=validValue
|Javascript_data_type=Boolean
|Return_value_description=Whether a value has no validity errors.
}}
{{Examples_Section
|Not_required=No
|Examples=
...
{{Notes_Section
|Notes=The following example displays all validation states for a validated field.
