...
{{Notes_Section
|Notes====Remarks===
This event only fires when the object is databound and an [[dom/Event/beforeupdate|'''onbeforeupdate''']] event has fired (for example, because the data has changed).
