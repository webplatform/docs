...
|Notes=The [[dom/properties/currentTarget|'''currentTarget''']] property returns the element that the event handlers are being processed for during the capturing and bubbling phases.
}}
