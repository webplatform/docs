...
|Notes=
===Remarks===
You can set the '''defaultPrevented''' while processing an event by calling the [[dom/methods/preventDefault|'''preventDefault''']] method. If the event was initialized with the ''cancelable'' parameter of [[dom/methods/initEvent|'''initEvent''']] set to false, the default action cannot be prevented.
|Import_Notes=
===Syntax===
