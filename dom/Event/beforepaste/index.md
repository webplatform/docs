...
#Cancel the default behavior of the client by including '''event.returnValue{{=}}false''' in the [[dom/events/paste|'''onpaste''']] event handler. This guideline applies only to objects, such as the '''text box''', that have a defined default behavior.
...
#Invoke the [[dom/methods/getData|'''getData''']] method in the [[dom/events/paste|'''onpaste''']] event to execute custom code for pasting.
