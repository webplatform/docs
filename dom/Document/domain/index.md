...
{{API_Name}}
{{Summary_Section|Insecure. Use the web messaging API ([[dom/Window/postMessage|postMessage]] and the [[dom/Window/message|message]] event) instead. Gets or sets the security domain of the document.}}
{{API_Object_Property
|Property_applies_to=dom/Document
|Read_only=No
|Example_object_name=document
|Return_value_name=domain
|Javascript_data_type=String
|Return_value_description=The current security domain of the document.
|Example_value_name=topLevelDomain
}}
{{Examples_Section
|Not_required=No
|Examples=
