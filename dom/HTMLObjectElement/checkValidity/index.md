...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=retVal|Data type=boolean|Description=Returns true if the form passes validation, false otherwise.|Optional=}}
|Method_applies_to=dom/HTMLObjectElement
