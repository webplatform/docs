...
Portions of this content come from the Mozilla Developer Network [![cc-by-sa-small-wpd.svg](/assets/thumb/8/8c/cc-by-sa-small-wpd.svg/120px-cc-by-sa-small-wpd.svg.png)](http://creativecommons.org/licenses/by-sa/3.0/us/): [[Selection.getRangeAt](https://developer.mozilla.org/en-US/docs/Web/API/Selection.getRangeAt) Article]

Portions of this content come from the Microsoft Developer Network: [[getRangeAt Method](http://msdn.microsoft.com/en-us/library/ie/ff975177(v=vs.85).aspx) Article]
