...
Portions of this content come from the Mozilla Developer Network [![cc-by-sa-small-wpd.svg](/assets/thumb/8/8c/cc-by-sa-small-wpd.svg/120px-cc-by-sa-small-wpd.svg.png)](http://creativecommons.org/licenses/by-sa/3.0/us/): [[open](https://developer.mozilla.org/en-US/docs/Web/API/Window.open) Article]

Portions of this content come from the Microsoft Developer Network: [[open Method](http://msdn.microsoft.com/en-us/library/ie/ms536651(v=vs.85).aspx) Article]
