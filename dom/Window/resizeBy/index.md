...
Windows XP Service Pack 2 (SP2) or later. Windows that are located in the Internet Zone are subject to Window_Restrictions and will be forced to stay on screen. This applies to [[dom/methods/moveTo|'''moveTo''']], [[dom/methods/moveBy|'''moveBy''']], [[dom/methods/resizeTo|'''resizeTo''']], and '''resizeBy''' methods.
...
===Related pages (MSDN)===
*<code>window</code>
*<code>[[dom/methods/resizeTo|resizeTo]]</code>
}}
