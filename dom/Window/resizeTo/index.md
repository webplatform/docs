...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=x|Data type=Integer|Description='''Integer''' that specifies the width of the window in pixels. The value can be either positive or negative.|Optional=}}
{{Method Parameter|Name=y|Data type=Integer|Description='''Integer''' that specifies the height of the window in pixels. The value can be either positive or negative.|Optional=}}
...
Windows XP Service Pack 2 (SP2) or later. Windows that are located in the Internet Zone are subject to Window_Restrictions and will be forced to stay on screen. This applies to [[dom/methods/moveTo|'''moveTo''']], [[dom/methods/moveBy|'''moveBy''']], '''resizeTo''', and [[dom/methods/resizeBy|'''resizeBy''']] methods.
...
===Related pages (MSDN)===
*<code>window</code>
*<code>[[dom/methods/resizeBy|resizeBy]]</code>
}}
