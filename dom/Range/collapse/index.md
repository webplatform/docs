...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=toStart|Data type=VARIANT_BOOL|Description=Specifies one of the following values:|Optional=}}
...
*<code>[[dom/traversal/properties/collapsed|collapsed]]</code>
}}
