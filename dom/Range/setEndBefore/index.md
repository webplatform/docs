...
{{API_Name}}
{{Summary_Section|Sets the end of the range to a point before a specific node.}}
{{API_Object_Method
...
|Name=DOM
|URL=http://dom.spec.whatwg.org/#dom-range-setendbefore
...
|Is_CC-BY-SA=No
|Sources=MDN, MSDN
|MDN_link=[https://developer.mozilla.org/en-US/docs/Web/API/Range.setEndBefore Range.setEndBefore]
|MSDN_link=[http://msdn.microsoft.com/en-us/library/ie/ff975450(v=vs.85).aspx setEndBefore Method]
|HTML5Rocks_link=
}}