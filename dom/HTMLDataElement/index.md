...
summary: 'The HTMLDataElement is a DOM interface specific to handle what’s stored in &lt;data&gt; tags and inherits from  HTMLElement DOM object.'
tags:
  - API
  - Objects
  - DOM
...
[naturalHeight](/dom/HTMLElement/naturalHeight)
:

[naturalWidth](/dom/HTMLElement/naturalWidth)
:
...
[uniqueNumber](/dom/HTMLElement/uniqueNumber)
:
...
[acceptCharset](/html/attributes/acceptCharset)
:
...
[align (Table caption, legend element)](/html/attributes/align_(Table_caption,_legend_element))
:   Sets or retrieves a value that indicates the table alignment.

[align (Table, iframe elements)](/html/attributes/align_(Table,_iframe_elements))
:   Specifies the horizontal alignment of the content in an element. Not supported in HTML5. Use CSS instead.

[alinkColor](/html/attributes/alinkColor)
...
[axis](/html/attributes/axis)
:

[background (Body element)](/html/attributes/background_(Body_element))
:   Specifies a background image for a document. This attribute is deprecated in HTML4 and not supported in HTML5. Use CSS.

[background (Table, table cell, td, th elements)](/html/attributes/background_(Table,_table_cell,_td,_th_elements))
:   Specifies up to five separate background properties of an object.

[balance](/html/attributes/balance)
:

[bgColor](/html/attributes/bgColor)
:   Specifies the background color of a document. This is deprecated in HTML4 and [not supported in HTML5](http://www.w3.org/TR/html5/obsolete.html#non-conforming-features). Please use the CSS [Background Color](/css/properties/background-color) rule instead.
...
[borderColor](/html/attributes/borderColor)
:   Specifies the border color of the object.

[borderColorDark](/html/attributes/borderColorDark)
:

[borderColorLight](/html/attributes/borderColorLight)
...
[bottomMargin](/html/attributes/bottomMargin)
:
...
[declare](/html/attributes/declare)
:
...
[for](/html/attributes/dom/for)
:

[htmlFor](/html/attributes/dom/htmlFor)
:

[draggable](/html/attributes/draggable)
:

[encoding](/html/attributes/encoding)
:   Sets or retrieves the MIME encoding for the form.

[enctype](/html/attributes/enctype)
:

[event](/html/attributes/event)
:
...
[frameBorder](/html/attributes/frameBorder)
:   Sets or retrieves whether to display a border for the frame, frameset or iframe.

[frameSpacing](/html/attributes/frameSpacing)
:

[headers](/html/attributes/headers)
:
...
[href (base)](/html/attributes/href_(base))
:

[hreflang](/html/attributes/hreflang)
:

[hspace](/html/attributes/hspace)
...
[marginHeight](/html/attributes/marginHeight)
:

[marginWidth](/html/attributes/marginWidth)
:   Sets or retrieves the left and right margin widths before displaying the text in a frame.

[max (HTMLInputElement)](/html/attributes/max_(HTMLInputElement))
:   The max attribute specifies the maximum value for an \<input\> element.

[max(HTMLProgressElement)](/html/attributes/max(HTMLProgressElement))
:

[maxLength](/html/attributes/maxLength)
:   The **maxLength** attribute sets an upper limit on the number of characters that can be entered in an input element.

[method](/html/attributes/method)
:

[methods](/html/attributes/methods)
:
...
[HTML 5](http://www.w3.org/TR/html51/text-level-semantics.html#the-data-element)
:   W3C Recommendation
