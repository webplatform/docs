...
|Note=May return a number or a boolean value, if the attribute were with setAttribute and a number or boolean value, respectively (<code>element.setAttribute("wow", false)</code>).
}}
}}
{{See_Also_Section
