...
{{Method Parameter|Name=bstrname|Data type=BSTR|Description=The name of the desired attribute within the specified namespace.|Optional=}}
...
'''Variant''' value that returns a '''String''', '''Variant''' of type '''Integer''', or '''Boolean''' value  that  the attribute defines. If the attribute is not present, this method returns null.
