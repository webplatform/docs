...
This event is raised when the [**seeking**](/dom/Element/seeking) property changes to VARIANT\_FALSE. To invoke this event, do one of the following:
...
-   `Reference`
-   seeking[seeking](/dom/Element/seeking)
