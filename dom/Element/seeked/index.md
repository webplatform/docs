...
{{Flags
|State=In Progress
|Editorial notes=Needs summary, examples, and compat
|Checked_Out=No
...
{{Notes_Section
|Notes====Remarks===
This event is raised when the [[dom/Element/seeking|'''seeking''']] property changes to VARIANT_FALSE.
...
*<code>window</code>
*<code>Reference</code>
*<code>[[dom/Element/seeking|seeking]]</code>
}}
