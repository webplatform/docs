...
The ****seeking**** property changes to VARIANT\_TRUE during this operation. To invoke this event, do one of the following:
...
-   `Reference`
-   seeked[seeked](/dom/Element/seeked)
