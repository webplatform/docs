...
notes:
  - 'Needs summary, example, syntax, compat and better spec link'
readiness: 'Not Ready'
...
This event is dispatched first and occurs only one time. To invoke this event, do one of the following:
...
-   onloadedmetadata[onloadedmetadata](/dom/Element/loadedmetadata)
