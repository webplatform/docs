...
|Description=This example uses the '''onreadystatechange''' event to invoke a function when the [[dom/properties/readyState (Link, Img, Input, Style...elements)|'''readyState''']] is complete.
|LiveURL=
|Code=
