...
|Description=The following example sets an event handler that responds to both '''ononline''' and [[dom/events/offline|'''onoffline''']] events using the '''type''' property of the '''event''' object.
|LiveURL=
|Code=
