...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=pattr|Data type=IHTMLDOMAttribute|Description='''attribute'''|Optional=}}
...
*<code>wbr</code>
*<code>xmp</code>
*<code>[[dom/methods/setAttributeNode|setAttributeNode]]</code>
}}
