...
{{Flags
|State=In Progress
|Editorial notes=Needs summary, example, compat, and better spec link
|Checked_Out=No
...
;''handler'' [in]:Type: '''Function'''Handler function to process the oncuechange event.
}}
