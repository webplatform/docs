...
|Notes=
===Remarks===
You can determine the location, width, and height of an object by using a combination of the '''offsetLeft''', [[dom/properties/offsetTop|'''offsetTop''']], [[dom/properties/offsetHeight|'''offsetHeight''']], and [[dom/properties/offsetWidth|'''offsetWidth''']] properties. These numeric properties specify the physical coordinates and dimensions of the object relative to the object's offset parent.
