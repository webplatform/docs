...
{{Single_Example
|Description=This example uses the '''offsetWidth''' property and the [[dom/properties/clientWidth|'''clientWidth''']] property to show the different ways of measuring the object size.
...
|Notes=
===Remarks===
You can determine the location, width, and height of an object by using a combination of the [[dom/properties/offsetLeft|'''offsetLeft''']], [[dom/properties/offsetTop|'''offsetTop''']], [[dom/properties/offsetHeight|'''offsetHeight''']], and '''offsetWidth''' properties. These numeric properties specify the physical coordinates and dimensions of the object relative to the object's offset parent.
