...
{{API_Name}}
{{Summary_Section|Gets the distance that a mouse wheel has rotated around the z-axis.}}
{{API_Object_Property
|Property_applies_to=dom/WheelEvent
|Read_only=Yes
|Example_object_name=event
|Return_value_name=deltaZ
...
|Language=JavaScript
|Description=The following example shows how to determine the deltaZ property of the WheelEvent.
Note: to feature test for deltaZ you need to use the 'deltaZ' in event as deltaZ may have a value of 0 (false)... (event.deltaZ) can return false negatives.
...
|MSDN_link=[http://msdn.microsoft.com/en-us/library/ie/ff974801(v=vs.85).aspx deltaZ Property]
|HTML5Rocks_link=
}}