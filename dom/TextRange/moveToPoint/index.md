...
**Integer**Â that specifies the horizontal offset relative to the upper-left corner of the window, in pixels.
...
**Integer**Â that specifies the vertical offset relative to the upper-left corner of the window, in pixels.
...
Portions of this content come from the Microsoft Developer Network: [[moveToPoint Method](http://msdn.microsoft.com/en-us/library/ie/ms536632(v=vs.85).aspx) Article]
