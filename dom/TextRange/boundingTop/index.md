...
|Notes=
===Remarks===
'''Note'''  If the [[dom/traversal/TextRange|'''TextRange''']] is inside a '''textArea''' object, add the value of the element's [[dom/properties/scrollTop|'''scrollTop''']] property to the value of '''boundingTop'''.
|Import_Notes=
===Syntax===
}}
{{See_Also_Section
