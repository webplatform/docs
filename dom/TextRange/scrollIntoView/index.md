...
{{API_Name}}
{{API_Object_Method
|Parameters={{Method Parameter|Name=varargStart|Data type=VARIANT|Description='''Variant''' of type '''Boolean''' that specifies one of the following values:|Optional=}}
