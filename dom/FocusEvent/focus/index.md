...
For Microsoft Internet Explorer 5.5 and later, focus on a [[dom/Document|Document]], and the '''active element''' of a '''document''' can be managed separately. The synchronous events [[dom/UIEvent/activate|'''onactivate''']] and [[dom/UIEvent/deactivate|'''ondeactivate''']] provide better control for managing activation changes.
