...
|Notes=
===Remarks===
The '''ondragstart''' event is the first to fire when the user starts to drag the mouse. It is essential to every drag operation, yet is just one of several source events in the data transfer object model. Source events use the [[dom/methods/setData|'''setData''']] method of the [[dom/objects/dataTransfer|'''dataTransfer''']] object to provide information about data being transferred. Source events include '''ondragstart''', [[dom/events/drag|'''ondrag''']], and [[dom/events/dragend|'''ondragend''']].
...
*<code>xmp</code>
*<code>Reference</code>
*<code>[[dom/events/drop|ondrop]]</code>
