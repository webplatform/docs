...
{{API_Name}}
{{Summary_Section|Just like [[dom/methods/getElementsByTagName|document.getElementsByTagName]] except that it only works within the scope of this ShadowRoot's shadow tree.}}
{{API_Object_Method
