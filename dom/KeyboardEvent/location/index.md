...
|Notes=
===Remarks===
The '''location''' property is not set during [[dom/events/keypress|'''onkeypress''']] events. It is available only during [[dom/events/keydown|'''onkeydown''']] and [[dom/events/keyup|'''onkeyup''']] events.
|Import_Notes=
===Syntax===
