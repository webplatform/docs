...
|Read_only=Yes
|Example_object_name=checkboxElement
|Return_value_name=initiallyChecked
|Javascript_data_type=Boolean
|Return_value_description=Whether the '''checked''' HTML attribute is present on the element.
}}
{{Examples_Section
|Not_required=No
|Examples=
