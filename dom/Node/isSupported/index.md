...
{{Method Parameter|Name=version|Data type=VARIANT|Description=The version number of the standard.  Supported values vary according to the standard.|Optional=}}
...
*<code>video</code>
*<code>[[dom/methods/hasFeature|hasFeature]]</code>
}}
