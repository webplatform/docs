...
{{API_Name}}
{{Summary_Section|Retrieves the namespace URI of the fully qualified XML declaration for a node.}}
{{API_Object_Property
...
|Return_value_description=The namespace URI of the node, or null if there is none.
}}
{{Examples_Section
|Not_required=No
|Examples=
