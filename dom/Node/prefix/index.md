...
{{Notes_Section
|Usage=In XML documents, elements can be declared using ''qualified names'', which consist of a prefix and a [[dom/properties/localName|'''local name''']]. This property returns the former value.
...
*<code>video</code>
*<code>Reference</code>
*<code>[[dom/properties/localName|localName]]</code>
*<code>[[dom/properties/namespaceURI|namespaceURI]]</code>
}}
{{Topics|DOM}}
