...
|Notes=
===Remarks===
In XML documents, elements can be declared using ''qualified names'', which consist of a prefix and a [[dom/properties/localName|'''local name''']]. This property returns the former value.
