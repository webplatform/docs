...
[caption](/dom/HTMLTableElement/caption)
:   Gets or sets the caption element of a table.

[cellSpacing](/dom/HTMLTableElement/cellSpacing)
:

[tBodies](/dom/HTMLTableElement/tBodies)
:

[tFoot](/dom/HTMLTableElement/tFoot)
:
...
[createCaption](/dom/HTMLTableElement/createCaption)
:

[createTBody](/dom/HTMLTableElement/createTBody)
:

[createTFoot](/dom/HTMLTableElement/createTFoot)
:

[createTHead](/dom/HTMLTableElement/createTHead)
:

[deleteCaption](/dom/HTMLTableElement/deleteCaption)
:

[deleteCell](/dom/HTMLTableElement/deleteCell)
:

[deleteRow](/dom/HTMLTableElement/deleteRow)
:

[deleteTFoot](/dom/HTMLTableElement/deleteTFoot)
:

[deleteTHead](/dom/HTMLTableElement/deleteTHead)
:

[firstPage](/dom/HTMLTableElement/firstPage)
:

[insertCell](/dom/HTMLTableElement/insertCell)
:

[insertRow](/dom/HTMLTableElement/insertRow)
:

[lastPage](/dom/HTMLTableElement/lastPage)
:
