...
{{Method Parameter|Name=Count|Data type=Integer|Description='''Integer''' that specifies the number of characters to replace.|Optional=}}
{{Method Parameter|Name=bstrstring|Data type=BSTR|Description='''String''' that specifies the new character string.|Optional=}}
