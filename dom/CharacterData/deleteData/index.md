...
{{Method Parameter|Name=Count|Data type=Integer|Description='''Integer''' that specifies the number of characters to remove.|Optional=}}
...
Upon success of this method, the [[html/attributes/data|'''data''']] and [[dom/properties/length|'''length''']] properties reflect the change.
|Import_Notes=
===Syntax===
