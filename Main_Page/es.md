{{Page_Title|Bienvenido a Web Platform Docs}}
...
* Para reportar errores en la webplatform, usa el [http://project.webplatform.org/ página de Gestión del Proyecto]. Lee nuestra [http://docs.webplatform.org/wiki/WPD:Filing_Bugs página sobre reportar errores] para mayor información.
