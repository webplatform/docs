...
|}
 
Set the '''ariaInvalid''' state to indicate that the user input is incorrect or not within acceptable ranges. To indicate that input is required, use [[aria/attributes/aria-required|'''ariaRequired''']].
...
*<code>[http://go.microsoft.com/fwlink/p/?linkid{{=}}203793 W3C ARIA-Invalid]</code>
}}
