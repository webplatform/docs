...
|}
 
Buttons with a defined '''aria-pressed''' state can be toggled. (When '''aria-pressed''' is '''true''' the button is down, when '''false''' it is up.) Simple command buttons do not need to define a '''aria-pressed''' state.
...
*<code>[http://go.microsoft.com/fwlink/p/?linkid{{=}}203793 W3C ARIA-Pressed]</code>
}}
