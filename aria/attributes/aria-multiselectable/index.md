...
{{!}}}
 
This property indicates whether a user may select more then one item
from the current list. Lists, trees, and grids may allow users to select
more than one item.
...
*<code>[http://go.microsoft.com/fwlink/p/?linkid{{=}}203793 W3C ARIA-Multiselect]</code>
}}
{{Topics|ARIA}}
