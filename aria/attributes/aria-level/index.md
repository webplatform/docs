...
{{!}}}
 
This property indicates the level of an element within a structure.
The level value is 1 or greater.
...
*<code>[http://go.microsoft.com/fwlink/p/?linkid{{=}}203793 W3C ARIA-Level]</code>
}}
{{Topics|ARIA}}
