...
{{Summary_Section|Gets a new Float32Array view of the [[javascript/ArrayBuffer{{!}}ArrayBuffer Object]] store for this array, specifying the first and last members of the subarray.}}
{{JS_Syntax
|Formats={{JS Syntax Format
|Format=var newFloat32Array = float32Array.subarray(begin, end);
}}
...
|Sources=MSDN
|MDN_link=
|MSDN_link=http://msdn.microsoft.com/en-us/library/ie/br230723(v=vs.94).aspx
|HTML5Rocks_link=
}}