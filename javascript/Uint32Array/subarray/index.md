{{Page_Title}}
{{Flags}}
{{Summary_Section|Gets a new Int8Array view of the [[javascript/ArrayBuffer{{!}}ArrayBuffer Object]] store for this array, specifying the first and last members of the subarray.

}}
{{JS_Syntax|Formats={{JS_Syntax_Format
|Format= var newUint32Array = uint32Array.subarray(begin, end);}}
