{{Page_Title}}
{{Flags}}
{{Summary_Section|Returns the last matched characters from any regular expression search. Read-only.

}}
{{JS_Syntax|Formats={{JS_Syntax_Format
|Format= '''RegExp'''.'''lastMatch'''}}
}}
{{Remarks_Section
...
|Language=JavaScript
|Description=The following example illustrates the use of the '''lastMatch''' property:
...
|Sources=MSDN
|MDN_link=
|MSDN_link=http://msdn.microsoft.com/en-us/library/ie/3k9c4a32(v=vs.94).aspx
|HTML5Rocks_link=
}}