...
|Name=callbackfn
|Required=Required
|Description=A function that accepts up to three arguments. The '''filter''' method calls the callbackfn function one time for each element in the array.}}{{JS_Syntax_Parameter
|Name=thisArg
|Required=Optional
